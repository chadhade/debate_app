class DebatesController < ApplicationController
  ...
  def join
    ...
    debate_link_joined = render(:partial => "/judgings/debate_link_joined", :locals => {:debate => @debate, :joined_no_judge => Debate.judging_priority(30).last.paginate(:page => params[:page], :per_page => 10)}, :layout => false)	  
